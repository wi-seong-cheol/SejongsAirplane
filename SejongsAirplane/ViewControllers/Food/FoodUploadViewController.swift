//
//  FoodUploadViewController.swift
//  SejongsAirplane
//
...
class FoodUploadViewController: UIViewController {
            ...
            (metaData, error) in if let error = error {
                ...
                imageReference.downloadURL { url, error in
                    if let error = error {
                        ...
                        db.roomDataSet(item: item)
                        self.OKDialog("맛집이 업로드 되었습니다.")
                    }
                }
            }
        }
...
extension FoodUploadViewController: UINavigationControllerDelegate, CropViewControllerDelegate {
...
extension FoodUploadViewController: UIImagePickerControllerDelegate {
    func openGallary() {
